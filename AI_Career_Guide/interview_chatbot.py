...
# Load datasets
df_career = pd.read_csv("AI_Career_Guide/Career QA Dataset.csv")
df_mock = pd.read_csv("AI_Career_Guide/Mock-Interview-Questions.csv")
df_smalltalk = pd.read_csv("AI_Career_Guide/customSmalltalkResponses_en.csv")
